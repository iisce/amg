    ...
    <footer className="border-t bg-secondary text-secondary-foreground">
      <div className="container mx-auto px-4 py-8 lg:px-8 lg:py-12">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-2">
              <div className="flex h-10 w-10 items-center justify-center rounded-full bg-primary border-2 border-primary">
                <span className="text-xs font-bold text-primary-foreground">AMG</span>
              </div>
              <span className="text-lg font-bold">WORKSPACE</span>
            </div>
            <p className="text-sm text-secondary-foreground/80">Do more than just work. Create. Innovate.</p>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3 text-sm text-secondary-foreground/80">
              ...
              <li className="flex items-center gap-2">
                ...
                <span>hello@amgworkspace.com</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-8 border-t border-secondary-foreground/20 pt-8 text-center text-sm text-secondary-foreground/60">
          <p>&copy; {new Date().getFullYear()} AMG Workspace. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
